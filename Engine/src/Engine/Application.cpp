...
void Application::createGraphicsPipeline() {
	//Windows harcoded shader compilation
	//const char* vulkanSDK = std::getenv("VULKAN_SDK");
	//std::string glslcPath;

	//if (vulkanSDK) {
	//	glslcPath = std::string(vulkanSDK) + "\\Bin\\glslc.exe";
	//}
	//// Compile vertex shader
	//std::string vertCmd = "\"" + glslcPath + "\" ../Shaders/GLSL/shader.vert -o ../Shaders/SPIRV/shader.vert.spv";
	//if (std::system(vertCmd.c_str()) != 0) {
	//	std::cerr << "Failed to compile vertex shader!" << std::endl;
	//}
	//// Compile fragment shader
	//std::string fragCmd = "\"" + glslcPath + "\" ../Shaders/GLSL/shader.frag -o ../Shaders/SPIRV/shader.frag.spv";
	//if (std::system(fragCmd.c_str()) != 0) {
	//	std::cerr << "Failed to compile fragment shader!" << std::endl;
	//}

	auto vertShaderCode = readFile("../Shaders/SPIRV/shader.vert.spv");
	auto fragShaderCode = readFile("../Shaders/SPIRV/shader.frag.spv");
...
void Application::updateUniformBuffer(uint32_t currentImage)
{
	...
	if (glm::length(inputDirection) > 0.0f) {
		...
		objectPosition += inputDirection * moveSpeed * deltaTime;
	}
	...
	glm::mat4 translation = glm::translate(glm::mat4(1.0f), objectPosition);
	glm::mat4 rotation = glm::rotate(glm::mat4(1.0f), time * glm::radians(90.0f), glm::vec3(0.0f, 0.0f, 1.0f));
	ubo.model = translation * rotation;

	ubo.view = glm::lookAt(glm::vec3(0.0f, 1.0f, 5.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
